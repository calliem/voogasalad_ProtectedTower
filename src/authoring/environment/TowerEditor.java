...
public class TowerEditor extends PropertyEditor{
    ...
    protected Group configureUI () {
        ...
        Rectangle background = new Rectangle(MainEnvironment.myDimensions.getWidth(), 0.9 * MainEnvironment.myDimensions.getHeight(), Color.BLUE);
    ...
    private void handleTowerEdit(){
        Rectangle overlay = new Rectangle(MainEnvironment.myDimensions.getWidth(), 0.9 * MainEnvironment.myDimensions.getHeight());
...
=======
>>>>>>> 0e1e78ec9d85c9d4d0619f71b0667eeb61faa7ec
}
