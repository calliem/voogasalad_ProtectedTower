...
public class CubicCurveManipulator extends Application {
  ...
  @Override public void start(final Stage stage) throws Exception {
    ...
    Anchor2 start    = new Anchor2(Color.PALEGREEN, curve.startXProperty(),    curve.startYProperty());
    Anchor2 control1 = new Anchor2(Color.GOLD,      curve.controlX1Property(), curve.controlY1Property());
    Anchor2 control2 = new Anchor2(Color.GOLDENROD, curve.controlX2Property(), curve.controlY2Property());
  ...
  class Anchor2 extends Circle { 
    Anchor2(Color color, DoubleProperty x, DoubleProperty y) {
