...
public class UpgradeTower {
	...
	/*
	 * This method finds a specific tower and, for all of its string upgrade
	 * references, adds the actual tower * object to its upgrade list instead of
	 * just the string reference
	 */
